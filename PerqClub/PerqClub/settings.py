"""
Django settings for PerqClub project.
...
SECRET_KEY = 'django-insecure-1@i2h@=eo6i-jjhwi5=97th_g0^!hmbwfzu!r93e-r27uu=psi'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user.context_processors.user_stats',
                'user.context_processors.admin_cafes',
            ],
        },
    },
]

WSGI_APPLICATION = 'PerqClub.wsgi.application'
